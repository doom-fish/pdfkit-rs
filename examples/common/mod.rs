...
pub fn output_dir() -> PathBuf {
    ...
    fs::create_dir_all(&dir).expect("create example output dir");
    dir
}
...
pub fn sample_goto_action(page: &PdfPage) -> Result<PdfActionGoTo> {
    let destination = sample_destination(page)?;
    PdfActionGoTo::new(&destination)
}
